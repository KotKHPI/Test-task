<x-layout>
    ...
    <h2 class="mb-6 rounded-md px-7 py-1 text-left font-medium text-slate-700 shadow-sm ring-1 ring-slate-700/10">
        Author's page
    </h2>
    ...
    <form action="{{ route('authors.index') }}" method="GET" class="mb-8 flex items-center space-x-2">
        <label>
